...
TEST_CASE("ComplexVariable")
{
    ...
    CHECK_THROWS(solve(y ^ 3) == (25.0, 5.0));
    CHECK_THROWS(solve(y ^ 3) == (-25.0, -5.0));
    CHECK_THROWS(solve(y / 0) == (2.0, 2.0));
    CHECK_THROWS(solve(y ^ 3) == (3.0, 3.0));
    CHECK_THROWS(solve(y ^ 3) == (-1.0, -4.0));
    CHECK_THROWS(solve(y / 0) == (0.0, 0.0));
    CHECK_THROWS(solve(y ^ 3) == (45.0, 23.0));
    CHECK_THROWS(solve(y ^ 4) == (-45.0, -3.0));
    CHECK_THROWS(solve(y / 0) == (4.0, 4.0));
    CHECK_THROWS(solve(2 * y + 5i == 2 * y + 5i) == (100.0, 100.0));
}
